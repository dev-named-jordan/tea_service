...
#
#     post "/api/v1/customers/#{@customer_1.id}/customer_subscriptions"
#
#     subscription = JSON.parse(response.body, symbolize_names:true)
#
#     expect(response).to be_successful
#     expect(response.status).to eq(200)
#     expect(subscription.first.keys).to match_array [:id, :name, :status, :price, :frequency_delivered, :created_at, :updated_at]
#   end
# end
